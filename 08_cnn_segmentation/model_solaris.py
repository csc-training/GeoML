...
Added comments and option to train multiclass labels and to change number of image bands.
"""
...
# The model is hard-coded for 512x512 tiles.
# Set the number of bands in training data
no_of_image_bands=8


def cosmiq_sn4_baseline(input_shape=(512, 512, no_of_image_bands), base_depth=64, no_of_classes=2):
    ...
    # Convolution with Conv2D and MaxPooling2D layers.
