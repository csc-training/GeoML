...
test -f /scratch/project_2019932/students/$USER/GeoML/data/raster/cnn/test/labels/labels_test.tif || cp -R /scratch/project_2019932/raster_data/cnn /scratch/project_2019932/students/$USER/GeoML/data/raster/

# Run the Python code
srun python3 07B_1_train_model.py
