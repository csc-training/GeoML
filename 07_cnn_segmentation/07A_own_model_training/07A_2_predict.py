...
#     * For prediction the test data is tiled with overlap to overcome edge-effects
...
#     * Predicted most likely classes - classification
#     * Probabilities for each class separately
